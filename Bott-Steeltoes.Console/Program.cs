...
namespace Bott_Steeltoes.Console
{
    ...
    class Program : Discord_Bot.Base
    {
        ...
        {
            { "Aasimar", new [] { "Fallen", "Protector", "Scourge" } },
            { "Dragonborn", new [] { "Black", "Blue", "Brass", "Bronze", "Copper", "Gold", "Green", "Red", "Silver", "White" } },
            { "Dwarf", new [] { "Arctic", "Azer", "Cloud", "Duergar", "Gold", "Highland", "Hill", "Mountain", "Rune", "Wild" } },
            { "Elf", new [] { "Aquatic", "Avariel", "Blood", "Drow", "Eladrin", "Frost", "High", "Moon", "Selvari", "Shadar-Kai", "Star", "Wood" } },
            ...
            { "Half-Dwarf", new [] { "Arctic", "Azer", "Cloud", "Duergar", "Gold", "Highland", "Hill", "Mountain", "Rune", "Wild" } },
            { "Half-Elf", new [] { "Aquatic", "Avariel", "Blood", "Drow", "Eladrin", "Frost", "High", "Moon", "Selvari", "Shadar-Kai", "Star", "Wood" } },
